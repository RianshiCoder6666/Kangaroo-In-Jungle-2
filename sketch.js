...
function setup() {
  ...
  restart.addImage("gameRestart", restartImg);
...
function draw() {
  ...
  stroke(3);
  fill("black");
  text("Score: " + score, camera.position.x /3 -100, 50);
  ...
  if(score >= 7) {
    ...
    stroke(3);
    fill("black");
    text("Congratulations!! You win the game!! ", camera.position.x - 250, 150);
    gameState = WIN;
    restart.position.x = 750;
    restart.position.y = 50;
    restart.visible = true;
  }
